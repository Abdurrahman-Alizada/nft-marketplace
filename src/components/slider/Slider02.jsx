                    ...
                    <div className="slider-inner flex home-1 style-2">
                        ...
                        <div className="slider-img flex">
                            ...
                            <div className="img-right">
                                <img src={props.item.img3} alt="nft" />
                                <div className="box-avatar flex">
                                    <div className="list-avatar flex">
                                        <img src={props.item.avt1} alt="nft" />
                                        <img src={props.item.avt2} alt="nft" />
                                        <img src={props.item.avt3} alt="nft" />
                                        <img src={props.item.avt4} alt="nft" />
                                    </div>
